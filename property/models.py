...
class Flat(models.Model):
    ...
    liked_by = models.ManyToManyField(User, verbose_name="Кто лайкнул", related_name="liked_posts", blank=True, db_index=True)
...
class Owner(models.Model):
    ...
    flats_owned = models.ManyToManyField(Flat, verbose_name="Квартиры в собственности", related_name="flats_owned_by", blank=True, db_index=True)
    
    def __str__(self):
        return f"{self.owner}"


class Report_flat(models.Model):
